                ...
                <Fragment key={company.id}>
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-sm text-muted max-w-[200px] truncate">
                      {company.translatedCapabilitySummary || company.capabilitySummary || '—'}
                    </td>
                    <td className="px-4 py-3">
                      {currentVote ? (
                      ...
                      <td colSpan={7} className="p-0">
                        <div className="border-t border-border bg-surface2/50">
                          <div className="p-5 space-y-5">
                            ...
                            {(company.capabilitySummary || company.translatedCapabilitySummary) && (
                              <div className="space-y-2">
                                <div className="text-[10px] font-semibold text-muted uppercase tracking-wider">{t('Signals')}</div>
                                <p className="text-sm text-muted leading-relaxed">{company.translatedCapabilitySummary || company.capabilitySummary}</p>
                              </div>
                            )}
                          </div>
                        </div>
