...
import { DiscoveryProvider } from '@/core/providers/base';
import { RegulatoryProvider } from '@/core/providers/regulatory';
import { GooglePlacesProvider } from '@/core/providers/google';
import { TomTomProvider } from '@/core/providers/tomtom';
import { OverpassProvider } from '@/core/providers/overpass';
...
export const VERTICAL_REGISTRY: Record<string, VerticalConfigWithProviders> = {
  ...
  distressed_property: {
    ...
    slug: 'distressed_property',
    industryName: 'Distressed & Vacant Property Identification',
    searchQueries: [
      'vacant property', 'distressed property', 'foreclosure',
      'property tax delinquent', 'abandoned building'
    ],
    targetNaicsCodes: ['531320', '531210', '531390'],
    equipmentKeywords: [],
    negativeKeywords: [
      'residential rental', 'luxury', 'new construction'
    ],
    signals: {
      primary: [
        { term: 'vacant', weight: 25 },
        { term: 'distressed', weight: 25 },
        { term: 'foreclosure', weight: 25 },
        { term: 'abandoned', weight: 25 },
      ],
      secondary: [
        { term: 'tax lien', weight: 10 },
        { term: 'code violation', weight: 10 },
        { term: 'boarded', weight: 10 },
      ],
      negative: [
        { term: 'new listing', weight: -30 },
        { term: 'luxury', weight: -30 },
      ],
    },
    scoringWeights: SHARED_SCORING_WEIGHTS,
    baseScoringWeights: { distanceWeight: 10, contactEnrichmentWeight: 10, assetSignalWeight: 25 },
    createdAt: NOW,
    providers: createSearchOnlyProviders(),
  },

  multifamily: {
    id: 'multifamily',
    slug: 'multifamily',
    industryName: 'Multifamily Property Management & Development',
    searchQueries: [
      'apartment complex management', 'multifamily developer',
      'property management company', 'apartment owner'
    ],
    targetNaicsCodes: ['531311', '531312', '236116'],
    equipmentKeywords: [],
    negativeKeywords: [
      'single family', 'condo association', 'timeshare'
    ],
    signals: {
      primary: [
        { term: 'apartment', weight: 25 },
        { term: 'multifamily', weight: 25 },
        { term: 'property management', weight: 25 },
      ],
      secondary: [
        { term: 'real estate', weight: 10 },
        { term: 'building owner', weight: 10 },
      ],
      negative: [
        { term: 'single family', weight: -30 },
      ],
    },
    scoringWeights: SHARED_SCORING_WEIGHTS,
    baseScoringWeights: { distanceWeight: 10, contactEnrichmentWeight: 10, assetSignalWeight: 25 },
  ...
  commercial_real_estate: {
    ...
    industryName: 'Commercial Real Estate & Facility Management',
    searchQueries: [
      'commercial property owner', 'facility management company',
      'commercial real estate developer', 'strip mall owner'
    ],
    targetNaicsCodes: ['531120', '531312', '236220'],
    equipmentKeywords: [],
    negativeKeywords: [
    ...
    signals: {
      primary: [
        { term: 'commercial property', weight: 25 },
        { term: 'facility management', weight: 25 },
        { term: 'real estate development', weight: 25 },
      ],
      secondary: [
        { term: 'strip mall', weight: 10 },
        { term: 'office park', weight: 10 },
        { term: 'shopping center', weight: 10 },
      ],
      negative: [
        { term: 'residential', weight: -30 },
        { term: 'home', weight: -30 },
  ...
  industrial_property: {
    ...
    industryName: 'Industrial Property & Manufacturing Facilities',
    searchQueries: [
      'industrial property owner', 'manufacturing facility',
      'warehouse owner', 'industrial park management'
    ],
    targetNaicsCodes: ['531120', '236220', '493110'],
    equipmentKeywords: [],
    negativeKeywords: [
    ...
    signals: {
      primary: [
        { term: 'industrial', weight: 25 },
        { term: 'manufacturing', weight: 25 },
        { term: 'warehouse', weight: 25 },
      ],
      secondary: [
        { term: 'distribution center', weight: 10 },
        { term: 'industrial park', weight: 10 },
      ],
      negative: [
        { term: 'office space', weight: -30 },
      ],
    },
    scoringWeights: SHARED_SCORING_WEIGHTS,
    baseScoringWeights: { distanceWeight: 10, contactEnrichmentWeight: 10, assetSignalWeight: 25 },
  ...
  government_facilities: {
    ...
    slug: 'government_facilities',
    industryName: 'Government & Public Sector Facilities',
    searchQueries: [
      'government building', 'public works department',
      'municipal building', 'county facility manager'
    ],
    targetNaicsCodes: ['921110', '921120', '561210'],
    equipmentKeywords: [],
    negativeKeywords: [
      'private', 'residential', 'commercial only'
    ],
    signals: {
      primary: [
        { term: 'government', weight: 25 },
        { term: 'municipal', weight: 25 },
        { term: 'public works', weight: 25 },
        { term: 'county', weight: 25 },
      ],
      secondary: [
        { term: 'city hall', weight: 10 },
        { term: 'federal building', weight: 10 },
        { term: 'school district', weight: 10 },
      ],
      negative: [
        { term: 'private', weight: -30 },
      ],
    },
    scoringWeights: SHARED_SCORING_WEIGHTS,
    baseScoringWeights: { distanceWeight: 10, contactEnrichmentWeight: 10, assetSignalWeight: 25 },
  ...
  education_facilities: {
    ...
    slug: 'education_facilities',
    industryName: 'Educational Facility Management & Operations',
    searchQueries: [
      'school district facility manager', 'university facilities',
      'college campus maintenance', 'school board'
    ],
    targetNaicsCodes: ['611110', '611310', '561210'],
    equipmentKeywords: [],
    negativeKeywords: [
      'tutoring', 'online education', 'daycare'
    ],
    signals: {
      primary: [
        { term: 'school', weight: 25 },
        { term: 'university', weight: 25 },
        { term: 'college', weight: 25 },
        { term: 'school district', weight: 25 },
      ],
      secondary: [
        { term: 'campus', weight: 10 },
        { term: 'board of education', weight: 10 },
        { term: 'facilities management', weight: 10 },
      ],
      negative: [
        { term: 'online', weight: -30 },
        { term: 'tutoring', weight: -30 },
      ],
    },
    scoringWeights: SHARED_SCORING_WEIGHTS,
    baseScoringWeights: { distanceWeight: 10, contactEnrichmentWeight: 10, assetSignalWeight: 25 },
  ...
  healthcare_facilities: {
    ...
    industryName: 'Healthcare Facility Management & Operations',
    searchQueries: [
      'hospital facility manager', 'medical office building owner',
      'healthcare facility management', 'clinic owner'
    ],
    targetNaicsCodes: ['622110', '621491', '561210'],
    equipmentKeywords: [],
    negativeKeywords: [
      'dental lab', 'pharmacy only', 'home health'
    ],
    signals: {
      primary: [
        { term: 'hospital', weight: 25 },
        { term: 'medical center', weight: 25 },
        { term: 'healthcare', weight: 25 },
        { term: 'clinic', weight: 25 },
      ],
      secondary: [
        { term: 'urgent care', weight: 10 },
        { term: 'medical office', weight: 10 },
        { term: 'surgical', weight: 10 },
      ],
      negative: [
        { term: 'veterinary', weight: -30 },
        { term: 'dental', weight: -20 },
      ],
    },
    scoringWeights: SHARED_SCORING_WEIGHTS,
    baseScoringWeights: { distanceWeight: 10, contactEnrichmentWeight: 10, assetSignalWeight: 25 },
