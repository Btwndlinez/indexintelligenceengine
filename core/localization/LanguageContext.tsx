...
const esDictionary: Record<string, string> = {
  ...
  'Score': 'Puntaje',
  'Contact': 'Contacto',
  'Lead Score': 'Puntaje del Cliente',
  'Discovering companies...': 'Descubriendo compañías...',
  'Searching, enriching contacts, detecting signals': 'Buscando, enriqueciendo contactos, detectando señales',
  'Set your parameters above and run a discovery search': 'Configure sus parámetros arriba y ejecute una búsqueda de descubrimiento',
};
